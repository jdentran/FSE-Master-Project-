...
This project was developed for an engineering class focused on creating solutions for accessibility challenges. The system uses an RGB color sensor and servo motors controlled by a Raspberry Pi to detect the color of clothing and automatically sort items into different bins.
